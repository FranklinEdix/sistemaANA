...
function Mostrar(event) {
    ...
    const parametros = "&producto=" + producto + "&compra=" + compra + "&cantidad=" + cantidad + "&formato=" + formato +
        "&fecha=" + fecha + "&distribuidora=" + distribuidora;
            ...
            <table class="  ">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" class="" value="<?php echo $vector[0]; ?>" name="Compra" <?php if ($b) {
                                                                                              echo 'disabled';
                                                                                            } ?> id="Compra"></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="">Formato: </label></th>
                        <td><input type="text" class="" value="<?php echo $vector[9]; ?>" name="Formato" <?php if ($b) {
                                                                                              echo 'disabled';
                                                                                            } ?> id="Formato"></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="">Cantidad: </label></th>
                        <td><input type="numeric" class="" value="<?php echo $vector[4]; ?>" name="Cantidad" <?php if ($b) {
                                                                                                  echo 'disabled';
                                                                                                } ?> id="Cantidad">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="" value="<?php echo $vector[1]; ?>" name="Producto" <?php if ($b) {
                                                                                                echo 'disabled';
                                                                                              } ?> id="Producto"></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="">Distribuidora: </label></th>
                        <td><input type="text" class="" value="<?php echo $vector[2]; ?>" name="Fecha" <?php if ($b) {
                                                                                            echo 'disabled';
                                                                                          } ?> id="Distribuidora"></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="">Fecha: </label></th>
                        <td><input type="date" class="" value="<?php echo $vector[6]; ?>" name="Fecha" <?php if ($b) {
                                                                                            echo 'disabled';
                                                                                          } ?> id="Fecha"></td>
                    </tr>
                </tbody>
